 ...
 * edata_t should come from the same base that this hpa was initialized with.
 * Only complete extents should be added (i.e. those for which the head bit is
 * true, and for which their successor is either not owned by jemalloc or also
 * has a head bit of true).  It should be active, large enough to satisfy the
 * requested allocation, and not already in the emap.
 *
